...
@Component({
  ...
  template: `<app-globe [targetSatellite]="targetSatellite" [initialChatQuery]="chatQuery"></app-globe>`,
...
export class GlobePageComponent {
  ...
  readonly chatQuery       = this.route.snapshot.queryParamMap.get('q')         ?? undefined;
}
